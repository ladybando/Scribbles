...
data class NewScribble(val noteID: Int) {
}
//TODO correct methods below to swipe down to delete up to edit
/*abstract class SwipeTpDeleteCallback(context: Context) :
    ...
    private val backgroundColor = Color.parseColor("#a30000")
    ...
    override fun onChildDraw(
        ...
        // Draw the dark red delete background
